...
import com.example.cccc.kotlinstudy.bean.*
...
interface HomePresenter {
    ...
    interface OnCollectArticleListener {
         ...
         */
        fun collectArticleListener(id: Int, isAdd: Boolean)
         ...
         * @param isAdd true add, false remove
         */
        fun collectArticleSuccess(result: HomeListResponse)
